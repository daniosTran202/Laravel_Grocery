...
<div class="all-title-box">
    ...
    <div class="jumbotron mt-5">
        <div class="container">
            ...
            <p>Please choose product before to cart!</p>
            <p>
                <a class="btn btn-warning btn-lg" style="background: #b0b435;color:aliceblue;border:none" href="{{route('client.shop')}}">Back to shop</a>
            </p>
        </div>
    </div>
