                                ...
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    ...
                                    @foreach($pros as $pro)
                                        <div  class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div  href="#" class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        <a class="cart" href="{{route('cart.add', $pro -> id)}}">Add to Cart</a>
                                                    </div>
                                                </div>
                    ...
                    <div class="product-categori">
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                    <a href="{{route('client.shop')}}" class="list-group-item list-group-item-action">All</a>
                               @foreach($cats as $cat)
                                    <a href="{{route('client.category', ['id' => $cat->id,'slug' => Str::slug($cat->name)])}}" class="list-group-item list-group-item-action"> {{$cat->name}} <small class="text-muted">({{$cat->prods->count()}}) </small></a>
                                @endforeach
                            </div>
                        </div>
