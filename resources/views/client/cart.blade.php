    ...
    <div class="cart-box-main">
        <div class="container">
            ...
            <div class="row my-5">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="update-box">
                        <a href="{{route('client.shop')}}"><input value="Continue Shopping" type="submit"></a>
                        <a href="{{route('cart.clear', $cart['id'])}}" onclick="return confirm('Do You Want To Clear All In Cart ?')"><input value="Clear Cart" class="bg-danger" type="submit"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row my-5">
                ...
                <div class="col-12 d-flex shopping-box"><a href="{{route('order.checkout')}}" class="ml-auto btn hvr-hover">Checkout</a> </div>
            </div>
