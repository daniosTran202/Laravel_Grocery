...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="name" value="{{old('name')}}" placeholder=" Please Enter Blog Name">
            @error('name')
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="summary" value="{{old('summary')}}" placeholder="Please Enter Summary">
            @error('summary')
                <div class="alert alert-danger">
                    <button type="button" class="close"  data-dismiss="alert" aria-hidden="true">&times;</button>
                    <strong>{{$message}}</strong>
