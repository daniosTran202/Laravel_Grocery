...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{url('public/admin_lte3')}}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{url('public/admin_lte3')}}/dist/css/adminlte.min.css">
  <style>
    body{
      background-image: url("{{url('public/admin_lte3')}}/dist/img/admin_bg.jpg") ;
...
<div class="login-box" style="opacity:0.75;background-color: transparent;">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Admin</b>cPanel</a>
    </div>
    <div class="card-body">
